...
public class Main {
    ...
    // fungsi back untuk kembali ke website sebelumnya dan menghapus history terakhir
    public void back() {
        if (history.size() > 1) {
            history.removeFirst();// Menghapus history terakhir
            System.out.println("Back to: " + history.getFirst()); // Menampilkan website sebelumnya
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("view")) {
                ...
                String website = command.substring(7); // Mengambil URL setelah "browse "
